...
# -*- coding: utf-8 -*-
#
# dims-finalreport documentation build configuration file, created by
# copying dims-swplan on Mon Apr 18 12:32:07 PDT 2016
#
...
htmlhelp_basename = 'dims-finalreportdoc'
...
if os.environ.get('DOCSURL') is None:
    ...
    os.environ['DOCSURL'] = "http://demo.prisem.washington.edu:8080/docs/{}/html".format(
